...
class _RegisterFormPageState extends State<RegisterFormPage> {
  ...
  final List<String> _countries = ['Russia', 'Ukraine', 'Germany', 'France','Unselected'];
  String _selectedCountry = 'Unselected';
  final List<String> _gender = ['Male', 'Female', 'Unselected'];
  String _selectedGender = 'Unselected';
